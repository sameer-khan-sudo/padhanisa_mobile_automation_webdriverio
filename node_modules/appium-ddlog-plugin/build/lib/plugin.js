...
exports.default = exports.DatadogLogPlugin = void 0;

const {
  BasePlugin
} = require('appium/plugin');

const {
  hookGlobalLog
} = require('./appiumlog.js');
...
class DatadogLogPlugin extends BasePlugin {
  ...
  toSnakeCase(s) {
    return s && s.match(/[A-Z]{2,}(?=[A-Z][a-z]+[0-9]*|\b)|[A-Z]?[a-z]+[0-9]*|[A-Z]|[0-9]+/g).map(x => x.toLowerCase()).join('_');
  }
...
exports.DatadogLogPlugin = DatadogLogPlugin;
var _default = DatadogLogPlugin;
